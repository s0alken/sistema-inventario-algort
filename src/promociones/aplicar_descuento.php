...
$descuento = strlen($descuento) === 0 ? $_SESSION["sistema"]["promocion"][$tipo_descuento] : intval($descuento);
...
$_SESSION["sistema"]["promocion"][$tipo_descuento] = $descuento;

configurarMontos();

echo json_encode(array("aplicado" => true, "mensaje" => "¡Descuento aplicado al total de la promoción!"));
