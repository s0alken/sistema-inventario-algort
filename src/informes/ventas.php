...
require_once "cargar_ventas.php";
  ...
  <div class="box-content">
    ...
    <div class="form-row">
      ...
      <div class="col-lg-3 mb-3 d-flex align-items-end">
        <button type="button" id="btn_filtrar" class="btn btn-primary btn-sm btn-block rounded-pill" value="cargar_ventas.php">Filtrar</button>
      </div>
      <div class="col-lg-3 mb-3 d-flex align-items-end">
    ...
    <div id="resultados"><?php cargarVentas() ?></div>
