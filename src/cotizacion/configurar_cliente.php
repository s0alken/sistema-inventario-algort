...
$_SESSION["sistema"]["cotizacion"]["cliente"] = $cliente ? $cliente : $_SESSION["sistema"]["cotizacion"]["cliente"];
...
echo json_encode(array_merge(array("agregado" => true, "mensaje" => "¡Cliente agregado a la cotizacion!"), $cliente));
