  ...
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form class="form-item form-persona-crear" action="../personas/crear_controller.php?tipo_persona=cliente&redireccionar=false&configurar_producto=false&configurar_venta=false&configurar_cotizacion=true&configurar_actualizacion_stock=false" method="POST">
