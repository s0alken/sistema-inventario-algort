  ...
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form class="form-item form-persona-crear" action="../personas/crear_controller.php?tipo_persona=proveedor&redireccionar=false&configurar_producto=false&configurar_venta=false&configurar_cotizacion=false&configurar_actualizacion_stock=true" method="POST">
