...
$query = $pdo->prepare("
    ...
    ce.cierra_venta AS estado_cierra_venta
    FROM compra c
...
<div class="p-0 px-md-4">
  ...
  <hr>
    ...
    <?php if (!$compra->estado_cierra_venta): ?>
        
        <div class="form-row justify-content-center">
        
            <div class="col-sm-4 mb-2">

              <a class="btn btn-info btn-sm btn-block rounded-pill" href="<?php echo '../ventas_web_procesar/procesar_venta_web.php?id_compra=' . $compra->id_compra ?>">
                  Procesar compra
              </a>
    ...
    <div class="form-row justify-content-center mb-2">
        <div class="col-sm-4">
          <a href="<?php echo 'imprimir.php?id=' . $compra->id_compra ?>" class="btn btn-success btn-sm btn-block rounded-pill" target="_blank">Imprimir</a>
        </div>
    </div>
