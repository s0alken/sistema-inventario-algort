...
require_once "cargar_ventas_web_procesar.php";
  ...
  <div class="box-content">
    ...
    <div class="form-row">
      <div class="col-lg-4 mb-3">
        <input type="text" name="myInput" id="myInput" class="form-control form-control-sm rounded-pill" placeholder="Buscar compra por procesar">
      </div>
    </div>
