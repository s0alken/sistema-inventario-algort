...
<div class="modal fade" id="modal_crear_cliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form class="form-item form-persona-crear" action="../personas/crear_controller.php?tipo_persona=cliente&redireccionar=false&configurar_producto=false&configurar_venta=true&configurar_cotizacion=false&configurar_actualizacion_stock=false" method="POST">
          ...
          <div class="form-row justify-content-center text-center">
            <div class="form-check col-md-4 mb-3">
              <input type="checkbox" class="form-check-input" id="persona_alternativa" name="persona_alternativa" value="proveedor">
              <label class="form-check-label" for="persona_alternativa">Habilitar como proveedor</label>
            </div>
          </div>
