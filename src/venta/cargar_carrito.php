...
if (isset($_POST["carga_automatica"])) {
    ...
    session_start();
    cargarCarrito($_SESSION["sistema"]["venta"]["carrito"]);
            ...
            <td class="text-center">
                <div class="dropdown dropleft">
                  ...
                  <div class="dropdown-menu" aria-labelledby="<?php echo $codigo_barras ?>">
                    ...
                    <button type="button" class="dropdown-item btn-quitar-del-carrito" value="<?php echo $codigo_barras ?>">Quitar de la venta</button>
                  </div>
                </div>
            </td>
        </tr>
