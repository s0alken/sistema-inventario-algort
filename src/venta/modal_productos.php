          ...
          <table class="table table-hover table-bordered table-sm" id="tabla_modal_productos">
            ...
            <?php foreach ($productos as $producto): ?>
              ...
              <tr>
                ...
                <td>
                  <button class="btn btn-primary btn-sm btn-block rounded-pill text-nowrap btn-agregar-venta" type="button" value="<?php echo $producto->codigo_barras ?>">Agregar a la venta</button></td>
              </tr>
